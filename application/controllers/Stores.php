...
class Stores extends Admin_Controller 
{
	...
	public function fetchStoresData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateStore', $this->permission)) {
				$buttons = '<button type="button" class="btn btn-primary" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>';
			}
    ...
    */
	public function update($id)
	{
		...
		if($id) {
			$this->form_validation->set_rules('edit_store_name', 'Store name', 'trim|required|alpha');
