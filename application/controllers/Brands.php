...
class Brands extends Admin_Controller 
{
	...
	*/
	public function fetchBrandData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('viewBrand', $this->permission)) {
				$buttons .= '<button type="button" class="btn btn-primary" onclick="editBrand('.$value['id'].')" data-toggle="modal" data-target="#editBrandModal" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>';	
			}
			
			if(in_array('deleteBrand', $this->permission)) {
				$buttons .= ' <button type="button" class="btn btn-danger" onclick="removeBrand('.$value['id'].')" data-toggle="modal" data-target="#removeBrandModal" data-toggle="tooltip" title="Delet"><i class="fa fa-trash"></i></button>
				';
			}				
	...
	*/
	public function create()
	{
		...
		$this->form_validation->set_rules('brand_name', 'Brand name', 'trim|required|alpha');
