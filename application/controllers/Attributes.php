...
class Attributes extends Admin_Controller 
{
	...
	*/
	public function fetchAttributeData()
	{
		...
		foreach ($data as $key => $value) {
			...
			<button type="button" class="btn btn-primary" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
			<button id="delete" type="button" class="btn btn-danger" onclick="removeFunc('.$value['id'].')" data-toggle="modal" data-target="#removeModal" data-toggle="tooltip" title="Delet"><i class="fa fa-trash"></i></button>
			';
	...
	*/
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('attribute_name', 'Attribute name', 'trim|required|alpha');
	...
	*/
	public function fetchAttributeValueData($attribute_parent_id)
	{
		...
		foreach ($data as $key => $value) {
			...
			// button
			$buttons = '
			<button type="button" class="btn btn-primary" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i></button>
