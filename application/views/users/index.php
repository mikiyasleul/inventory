                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(in_array('updateUser', $user_permission)): ?>
                            <a href="<?php echo base_url('users/edit/'.$v['user_info']['id']) ?>" class="btn btn-primary" data-toggle="tooltip"  title="Edit"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                          <?php if(in_array('deleteUser', $user_permission)): ?>
                            <button type="button" class="btn btn-danger" onclick="removeFunc('.$value['id'].')" data-toggle="modal" data-target="#removeModal"  data-toggle="tooltip fade top in" title="Delet"><i class="fa fa-trash"></i></button>
                          <?php endif; ?>
                        </td>
                      <?php endif; ?>
                      </tr>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
         <form action=" <?php echo base_url('users/delete/'.$v['user_info']['id']) ?>" method="post">
